...
public class calcularConsumoTotal {
    // Função para calcular o consumo total de dados móveis
    public static int consumoTotal(String[] consumoSemanal) {
        int total = 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Insira os consumos semanais separados por vírgula:");
        ...
        int totalConsumo = consumoTotal(consumoSemanal);
